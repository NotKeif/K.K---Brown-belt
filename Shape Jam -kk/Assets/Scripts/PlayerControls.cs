    ...
    void Update()
    {
        ...
        if ((Input.GetKey("space") || Input.GetKey("z")) && (Time.time > nextFire)) 
        {
            ...
            if (currentLevel >= 5)
            {
                ...
                Vector3 rearOffset = new Vector3(0, -0.2f, 0);
                Instantiate(projectile, transform.position + rightOffset, transform.rotation);
                Instantiate(projectile, transform.position + leftOffset, transform.rotation);
                Instantiate(projectile, transform.position + frontOffset, transform.rotation);
                Instantiate(projectile, transform.position + rearOffset, transform.rotation);
                Instantiate(projectile, transform.position, transform.rotation);
            }
